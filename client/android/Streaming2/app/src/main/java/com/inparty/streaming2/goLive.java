...
import com.inparty.broadcaster.ILiveVideoBroadcaster;
import com.inparty.broadcaster.LiveVideoBroadcaster;
import com.inparty.broadcaster.utils.Resolution;

//import static com.inparty.MainActivity.RTMP_BASE_URL;

public class goLive extends AppCompatActivity {

    public String RTMP_BASE_URL = "";

    private static final String TAG = goLive.class.getSimpleName();
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            if (mLiveVideoBroadcaster == null) {
                ...
                mLiveVideoBroadcaster.init(goLive.this, mGLView);
            ...
            case LiveVideoBroadcaster.PERMISSIONS_REQUEST: {
                if (mLiveVideoBroadcaster.isPermissionGranted()) {
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                        ...
                        new AlertDialog.Builder(goLive.this)
                ...
                if (!mLiveVideoBroadcaster.isConnected()) {
                    ...
                    new AsyncTask<String, String, Boolean>() {
                        ...
                        protected void onPreExecute() {
                            progressBar = new ContentLoadingProgressBar(goLive.this);
                            progressBar.show();
                        }
