...
***
__Nella pull request seleziona sempre il branch della funzionalità che stai modificando (le pull request al master non verranno considerate) e se stai inviando un codice non ancora finito segnalalo con il tag `In Progress`__
***
## Tipi di progetto:
